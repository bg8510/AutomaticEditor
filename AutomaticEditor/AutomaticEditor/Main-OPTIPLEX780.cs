...
namespace AutomaticEditor
{
    class Main
    {
        ...
        public void StartEditing(String introText, bool isAmericanStyle = true)
        {
            ...
            //result = StringReplacer("utilizes", "uses", "“Uses” is almost always a better word choice than “utilizes.”", commentHasBeenMade: result);
            ...
            StringReplacer("by using", "using", useCaps: false);
        ...
        private bool StringReplacer(String find, String replace, String commentText = "", bool useCaps = true, bool useWholeWord = true, bool commentHasBeenMade = false)
        {
            ...
            while(range.Find.Execute(FindText: find, ReplaceWith: replace))
            {
                ...
                if (!commentHasBeenMade && commentText != "")
                {
        ...
        private void spelldoink()
        {
            ...
            //object startLocation = currentDocument.Content.Start;
            //object endLocation = currentDocument.Content.End;
            //bool spellCheck = Globals.ThisAddIn.Application.CheckSpelling(
            //   Globals.ThisAddIn.Application.ActiveDocument.Range(ref startLocation, ref endLocation).Text);
